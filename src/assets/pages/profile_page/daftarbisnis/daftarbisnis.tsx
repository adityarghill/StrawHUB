...
export default function PopupDaftarkanBisnis({ open, onClose, onSubmit }: PopupDaftarkanBisnisProps) {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="fixed inset-0 z-50 flex items-end justify-center bg-black bg-opacity-50 p-0 sm:p-4"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          <motion.div
            className="bg-white rounded-t-3xl w-full sm:max-w-3xl max-h-[95vh] overflow-y-auto p-4 sm:p-6 relative shadow-lg"
          ...
          >
            ...
            {finished && (
              <motion.div 
                className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-green-500 bg-opacity-95 text-white rounded-t-3xl"
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          <input
            ...
            } p-3 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none transition-all`}
        ...
        <div>
          ...
          <textarea
            ...
            } p-3 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none transition-all min-h-24`}
        ...
        <div>
          ...
          <div className="flex gap-3 overflow-x-auto pb-2">
            {formData.photos.map((file, i) => (
              <div
                key={i}
                className="relative flex-none w-32 aspect-[3/4] rounded-lg overflow-hidden border-2 border-gray-200 group"
              >
                <img
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          {errors.agree && (
            ...
            {/* Navigation Buttons */}
            {!finished && (
              <div className="flex gap-3 mt-6 sm:mt-8 sticky bottom-0 bg-white pt-4 sm:pt-6 sm:bg-transparent">
                {step > 1 && (
                  <button
                    onClick={prevStep}
